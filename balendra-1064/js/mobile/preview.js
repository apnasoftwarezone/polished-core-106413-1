...
doPreviewAction = function (action, param1 ){
	alert('action : ' + action ) ;
	var html = '<form name="responsemainform" method="post" onsubmit="manualValidate(event, ' +  'addedittabularform' + ' )" ><table width="100%" cellpadding="1" cellspacing="5">' ;
			  ...
			  for(var i=0; i<choices.length; i++ ){
				  ...
				  //  isDefault = CHOICE_DEFAULT_SELECTION_YES
					...
					if(choices[i].isDefault*1 == CHOICE_DEFAULT_SELECTION_YES && isSelected != true  )	
						html += '<label><input type="checkbox" name="' + name + '" title="Select your choice" value="' + choices[i].id + '" checked onchange="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')"  /> ' + utilObject.decode64( choices[i].choice ) + '<label>' ;
					else if(choices[i].selected*1 == CHOICE_SELECTED_YES)
						html += '<label><input type="checkbox" name="' + name + '" title="Select your choice" value="' + choices[i].id + '" checked onchange="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')"  /> ' + utilObject.decode64( choices[i].choice ) + '<label>' ;
					else
						html += '<label><input type="checkbox" name="' + name + '" title="Select your choice" value="' + choices[i].id + '" onchange="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')"  /> ' + utilObject.decode64( choices[i].choice ) + '<label>' ;
			...
			html += '<tr><td colspan="2"><table id="' + qTable +  '"  width="100%" style="display:none;"  >'
				...
				for(var i=0; i<choices.length; i++){	 			
					...
					html += '<tr><td valign="top">'
						if(choices[i].isDefault*1 == CHOICE_DEFAULT_SELECTION_YES && isSelected != true  )	
							html += '<label><input type="checkbox" name="' + name + '" value="' + choices[i].id + '" checked onchange="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')"  /> ' + '' + '<label>' ;
						else if(choices[i].selected*1 == CHOICE_SELECTED_YES)
							html += '<label><input type="checkbox" name="' + name + '" value="' + choices[i].id + '" checked onchange="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')"  /> ' + '' + '<label>' ;
						else
							html += '<label><input type="checkbox" name="' + name + '" value="' + choices[i].id + '" onchange="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')"  /> ' + '' + '<label>' ;
			...
			if(choices.length <= currentObject.MaxRadioButtonCount ){ // show radio
				   ...
				   for(var i=0; i<choices.length; i++){	 			
					  ...
					  //  isDefault = CHOICE_DEFAULT_SELECTION_YES
						...
						html += '<tr><td valign="top">'
						if(choices[i].isDefault*1 == CHOICE_DEFAULT_SELECTION_YES && isSelected != true  )	
							html += '<label><input type="radio" name="' + name + '" value="' + choices[i].id + '" checked onchange="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')"  /> ' + '' + '<label>' ;
						else if(choices[i].selected*1 == CHOICE_SELECTED_YES)
							html += '<label><input type="radio" name="' + name + '" value="' + choices[i].id + '" checked onchange="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')"  /> ' + '' + '<label>' ;
						else
							html += '<label><input type="radio" name="' + name + '" value="' + choices[i].id + '" onchange="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')"  /> ' + '' + '<label>' ;
		...
		if(choices.length <= currentObject.MaxRadioButtonCount ){ // show radio
			   ...
			   for(var i=0; i<choices.length; i++){	 			
				  ...
				  //  isDefault = CHOICE_DEFAULT_SELECTION_YES
					...
					html += '<tr><td>&nbsp;&nbsp;'
					if(choices[i].isDefault*1 == CHOICE_DEFAULT_SELECTION_YES && isSelected != true  )	
						html += '<label><input type="radio" name="' + name + '" value="' + choices[i].id + '" checked onchange="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')"  /> ' + utilObject.decode64( choices[i].choice ) + '<label>' ;
					else if(choices[i].selected*1 == CHOICE_SELECTED_YES)
						html += '<label><input type="radio" name="' + name + '" value="' + choices[i].id + '" checked onchange="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')"  /> ' + utilObject.decode64( choices[i].choice ) + '<label>' ;
					else
						html += '<label><input type="radio" name="' + name + '" value="' + choices[i].id + '" onchange="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')"  /> ' + utilObject.decode64( choices[i].choice ) + '<label>' ;
			...
			// show in dropdown
				html += '<tr><td>'
			    html += '<select name="' + name + '" title="Select an option" class="form-control" required onchange="checkSavePoint(' + "'" + q.sectionId + "' , '" + "'" + q.id  + "', " + "'" + param2 + "'"   + ')"  >'
		...
		if(q.conditionalQuestionId*1 == -1 )
			...
			if(utilObject.trim( utilObject.decode64( q.answer ) ) != '' ){
				...
				if(q.type*1 == QUESTION_TYPE_EMAIL ){
					if(q.conditionalQuestionId*1 == -1 )
						html += '<input name="' + name + '" type="email" pattern"' + PATTERN_EMAIL + '" value="' + utilObject.decode64(q.answer) +  '" title="Enter email" placeholder="Enter email" class="form-control" required onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> '
					else
						html += '<input name="' + name + '" type="email" pattern"' + PATTERN_EMAIL + '" value="' + utilObject.decode64(q.answer) +  '" title="Enter email" placeholder="Enter email" class="form-control" onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> '
				}
				else if(q.type*1 == QUESTION_TYPE_Alphanumeric ){
					if(q.conditionalQuestionId*1 == -1 )
						html += '<input name="' + name + '" type="text" pattern"' + PATTERN_ALPHANUMERICWITHSPACE + '" value="' + utilObject.decode64(q.answer) +  '" title="Enter alphanumeric text" placeholder="Enter alphanumeric text" class="form-control" required onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> ' ;
					else
						html += '<input name="' + name + '" type="text" pattern"' + PATTERN_ALPHANUMERICWITHSPACE + '" value="' + utilObject.decode64(q.answer) +  '" title="Enter alphanumeric text" placeholder="Enter alphanumeric text" class="form-control" onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> '
				}
				else if(q.type*1 == QUESTION_TYPE_NUMBER_WITHOUT_DECIMAL ){
					if(q.conditionalQuestionId*1 == -1 )
						html += '<input name="' + name + '" type="number" pattern"' + PATTERN_INTEGER + '" value="' + utilObject.decode64(q.answer) +  '" title="Enter number" placeholder="Enter number" class="form-control" required onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> ' ;
					else
						html += '<input name="' + name + '" type="number" pattern"' + PATTERN_INTEGER + '" value="' + utilObject.decode64(q.answer) +  '" title="Enter number" placeholder="Enter number" class="form-control" onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')"  /> ' ;
				}
				else if(q.type*1 == QUESTION_TYPE_NUMBER_WITH_DECIMAL ){
					if(q.conditionalQuestionId*1 == -1 )
						html += '<input name="' + name + '" type="number" pattern="' + PATTERN_NUMBER_WITH_DECIMAL + '" value="' + utilObject.decode64(q.answer) +  '" title="Enter number" placeholder="Enter number" class="form-control" required onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> '
					else
						html += '<input name="' + name + '" type="number" pattern="' + PATTERN_NUMBER_WITH_DECIMAL + '" value="' + utilObject.decode64(q.answer) +  '" title="Enter number" placeholder="Enter number" class="form-control" onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')"  /> '
				}
				else if(q.type*1 == QUESTION_TYPE_TEXT_SINGLE_LINE ){
					if(q.conditionalQuestionId*1 == -1 )
						html += '<input name="' + name + '" type="text" value="' + utilObject.decode64(q.answer) +  '" title="Enter number" placeholder="Enter answer" class="form-control" required onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> '
					else
						html += '<input name="' + name + '" type="text" value="' + utilObject.decode64(q.answer) +  '" title="Enter number" placeholder="Enter answer" class="form-control" onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> '
				}
				else if(q.type == QUESTION_TYPE_WEBSITE ){
					if(q.conditionalQuestionId*1 == -1 )
						html += '<input name="' + name + '" type="url" pattern="' + PATTERN_URL + '"  value="' + utilObject.decode64(q.answer) +  '" title="Enter url" placeholder="Enter answer" class="form-control" required onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> '
					else
						html += '<input name="' + name + '" type="url" pattern="' + PATTERN_URL + '"  value="' + utilObject.decode64(q.answer) +  '" title="Enter url" placeholder="Enter answer" class="form-control" onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> '
				}
				else if(q.type*1 == QUESTION_TYPE_TEXT_MULTI_LINE ){
					if(q.conditionalQuestionId*1 == -1 )
						html += '<textarea name="' + name + '" value="" title="Enter answer" placeholder="Enter answer" class="form-control-textarea" required onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" >' + utilObject.decode64(q.answer) +  '</textarea> ' ;
					else
						html += '<textarea name="' + name + '" value="" title="Enter answer" placeholder="Enter answer" class="form-control-textarea" onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')"  >' + utilObject.decode64(q.answer) +  '</textarea> ' ;
				}
			}
			else{
				...
				if(q.type*1 == QUESTION_TYPE_EMAIL ){
					if(q.conditionalQuestionId*1 == -1 )
						html += '<input name="' + name + '" type="email" pattern"' + PATTERN_EMAIL + '" value="" title="Enter email" placeholder="Enter email" class="form-control" required onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> '
					else
						html += '<input name="' + name + '" type="email" pattern"' + PATTERN_EMAIL + '" value="" title="Enter email" placeholder="Enter email" class="form-control" onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> '
							
				}
				else if(q.type*1 == QUESTION_TYPE_Alphanumeric ){
					if(q.conditionalQuestionId*1 == -1 )
						html += '<input name="' + name + '" type="text" pattern"' + PATTERN_ALPHANUMERICWITHSPACE + '" value="" title="Enter alphanumeric text" placeholder="Enter alphanumeric text" class="form-control" required onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> ' ;
					else
						html += '<input name="' + name + '" type="text" pattern"' + PATTERN_ALPHANUMERICWITHSPACE + '" value="" title="Enter alphanumeric text" placeholder="Enter alphanumeric text" class="form-control" onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> '
				}
				else if(q.type*1 == QUESTION_TYPE_NUMBER_WITHOUT_DECIMAL ){
					if(q.conditionalQuestionId*1 == -1 )
						html += '<input name="' + name + '" type="number" pattern"' + PATTERN_INTEGER + '" value="" title="Enter number" placeholder="Enter number" class="form-control" required onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> ' ;
					else
						html += '<input name="' + name + '" type="number" pattern"' + PATTERN_INTEGER + '" value="" title="Enter number" placeholder="Enter number" class="form-control" onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> ' ;
				}
				else if(q.type*1 == QUESTION_TYPE_NUMBER_WITH_DECIMAL ){
					if(q.conditionalQuestionId*1 == -1 )
						html += '<input name="' + name + '" type="number" pattern"' + PATTERN_NUMBER_WITH_DECIMAL + '" value="" title="Enter number" placeholder="Enter number" class="form-control" required onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> '
					else
						html += '<input name="' + name + '" type="number" pattern"' + PATTERN_NUMBER_WITH_DECIMAL + '" value="" title="Enter number" placeholder="Enter number" class="form-control" onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> '
				}
				else if(q.type*1 == QUESTION_TYPE_TEXT_SINGLE_LINE ){
					if(q.conditionalQuestionId*1 == -1 )
						html += '<input name="' + name + '" type="text" value="" title="Enter number" placeholder="Enter answer" class="form-control" required onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> '
						else
							html += '<input name="' + name + '" type="text" value="" title="Enter number" placeholder="Enter answer" class="form-control" onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> '
				}
				else if(q.type == QUESTION_TYPE_WEBSITE ){
					if(q.conditionalQuestionId*1 == -1 )
						html += '<input name="' + name + '" type="url" pattern="' + PATTERN_URL + '"  value="" title="Enter url" placeholder="Enter answer" class="form-control" required onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> '
					else
						html += '<input name="' + name + '" type="url" pattern="' + PATTERN_URL + '"  value="" title="Enter url" placeholder="Enter answer" class="form-control" onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> '
				}
				else if(q.type*1 == QUESTION_TYPE_TEXT_MULTI_LINE ){
					if(q.conditionalQuestionId*1 == -1 )
						html += '<textarea name="' + name + '" value="" title="Enter answer" placeholder="Enter answer" class="form-control-textarea" required onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" ></textarea> ' ;
					else
						html += '<textarea name="' + name + '" value="" title="Enter answer" placeholder="Enter answer" class="form-control-textarea" onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" ></textarea> ' ;
				}
			}
				...
				html += '<tr><td ><table width="100%" class="alter1" >' 
			      ...
			      for(var i=from; i<=to; i=i+increment){
						...
						if(utilObject.decode64(q.answer)*1 == i )	
							html += '<label><input type="radio" name="' + name + '" value="' + i + '" checked onchange="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /><label>' ;
						else
							html += '<label><input type="radio" name="' + name + '" value="' + i + '" onchange="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /><label>' ;
			      ...
			      html += '</table></td></tr>' ;
					...
					// show in dropdown
						html += '<tr><td colspan="2">&nbsp;&nbsp;'
					    html += '<select name="' + name + '" title="Select an option" class="form-control" required onchange="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" >' ;
						html += '<option value="" selected >Select an option</option>' ;
						for(var i=from; i<=to; i=i+increment){	
							if(utilObject.decode64(q.answer)*1 == i )
			      		...
			      		for(var i=0; i<choices.length; i++ ){
			      			...
			      			if( j == 0 ){
			      				...
			      				var name1 = name + '-' + i ;
				      			   ...
				      			   if(choices[i].rank == j ) 
				      				 html += '<label><input type="radio" name="' + name1 + '" value="' + j + '" checked onchange="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /><label>' ;
				      			   else
				      				   html += '<label><input type="radio" name="' + name1 + '" value="' + j + '" onchange="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /><label>' ;
				      				html += '</td>'
 ...
 */
 getDateTimePickerTypeQuestion = function( q, param1, param2, sectionId ){
		...
		if( q.type == QUESTION_TYPE_DATE_PICKER ){ 
				...
				if( utilObject.trim( utilObject.decode64( q.answer ) ) != '' ){
					if(q.conditionalQuestionId*1 == -1 )
						html += '<input name="' + name + '" type="text" value="' + utilObject.decode64( q.answer ) + '" data-field="date" title="Select date" class="form-control" required onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> ' ;
					else
						html += '<input name="' + name + '" type="text" value="' + utilObject.decode64( q.answer ) + '" data-field="date" title="Select date" class="form-control" onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> ' ;
				}
				else
				{
					if(q.conditionalQuestionId*1 == -1 )
						html += '<input name="' + name + '" type="text" data-field="date" title="Select date" class="form-control" required onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> ' ;
					else
						html += '<input name="' + name + '" type="text" data-field="date" title="Select date" class="form-control" onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> ' ;
				}
			...
			if( utilObject.trim( utilObject.decode64( q.answer ) ) != '' ){
				if(q.conditionalQuestionId*1 == -1 )
					html += '<input name="' + name + '" type="text" value="' + utilObject.decode64( q.answer ) + '" data-field="time" title="Select date" class="form-control" required onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> ' ;
				else
					html += '<input name="' + name + '" type="text" value="' + utilObject.decode64( q.answer ) + '" data-field="time" title="Select date" class="form-control" onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> ' ;
			}
			else
			{
				if(q.conditionalQuestionId*1 == -1 )
					html += '<input name="' + name + '" type="text" data-field="time" title="Select date" class="form-control" required onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> ' ;
				else
					html += '<input name="' + name + '" type="text" data-field="time" title="Select date" class="form-control" onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> ' ;
			}		
		}		
		html += '</td></tr>' ;
		html += getAttachmentButton( q ) ;
        ...
        // From start here
  	   ...
  	   if( q.type == QUESTION_TYPE_DATE_RANGE_PICKER ){
	  		 ...
	  		 if( utilObject.trim( utilObject.decode64(q.from) != '' )){
		  			if(q.conditionalQuestionId*1 == -1 )
		  			 	html += '<input name="' + name1 + '" value="' + utilObject.decode64( q.from ) + '" type="text" data-field="date" title="Select date" class="form-control" required onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> ' ;
		  			else
		  				html += '<input name="' + name1 + '" value="' + utilObject.decode64( q.from ) + '" type="text" data-field="date" title="Select date" class="form-control" required onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> ' ;
	  		 }
	  		 else{
		  			if(q.conditionalQuestionId*1 == -1 )
		  			 	html += '<input name="' + name1 + '" type="text" data-field="date" title="Select date" class="form-control" required onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> ' ;
		  			else
		  				html += '<input name="' + name1 + '" type="text" data-field="date" title="Select date" class="form-control" required onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> ' ;
	  		 }
	  		html += '</td></tr>' ;
	  		...
	  		if( utilObject.trim( utilObject.decode64(q.to) != '' )){
		  			if(q.conditionalQuestionId*1 == -1 )
		  			 	html += '<input name="' + name2 + '" value="' + utilObject.decode64( q.to ) + '" type="text" data-field="date" title="Select date" class="form-control" required onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> ' ;
		  			else
		  				html += '<input name="' + name2 + '" value="' + utilObject.decode64( q.to ) + '" type="text" data-field="date" title="Select date" class="form-control" required onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> ' ;
	  		}
	  		else{
		  			if(q.conditionalQuestionId*1 == -1 )
		  			 	html += '<input name="' + name2 + '" type="text" data-field="date" title="Select date" class="form-control" required onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> ' ;
		  			else
		  				html += '<input name="' + name2 + '" type="text" data-field="date" title="Select date" class="form-control" required onblur="checkSavePoint(' + "'" + sectionId + "' , " + "'" + q.id  + "', " + "'" + param2 + "'"   + ')" /> ' ;
	  		}
	  		html += '</td></tr>' ;
